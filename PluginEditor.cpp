...
void MyLookAndFeel::drawRotarySlider(juce::Graphics &grafs,
                                     int x,
                                     int y,
                                     int width,
                                     int height,
                                     ...
                                     juce::Slider &slider)
{
    ...
    grafs.setColour(enabled ? Colour(97u, 18u, 167u) : Colours::darkgrey);
    grafs.fillEllipse(bounds);

    grafs.setColour(enabled ? Colour(255u, 154u, 1u) : Colours::grey);
    grafs.drawEllipse(bounds, 1.f);
    ...
    if (auto *rswl = dynamic_cast<RotarySliderWithLabels *>(&slider))
    {
        ...
        auto center_new = center.getY() - rswl->getTextHeight() * 1.5;
        r.setBottom(float(center_new));
        ...
        grafs.setFont(rswl->getTextHeight());
        auto text = rswl->getDisplayString();
        auto strWidth = grafs.getCurrentFont().getStringWidth(text);
        r.setSize(float(strWidth + 4), rswl->getTextHeight() + 2);
        r.setCentre(bounds.getCentre());

        grafs.setColour(enabled ? Colours::black : Colours::darkgrey);
        grafs.fillRect(r);

        grafs.setColour(enabled ? Colours::white : Colours::lightgrey);
        grafs.drawFittedText(text, r.toNearestInt(), juce::Justification::centred, 1);
    }
};
...
void RotarySliderWithLabels::paint(juce::Graphics &g)
{
    ...
    for (int i = 0; i < numChoices; ++i)
    {
        ...
        r.setSize(float(g.getCurrentFont().getStringWidth(str)), getTextHeight());
        r.setCentre(c);
...
juce::Rectangle<int> RotarySliderWithLabels::getSliderBounds() const
{
    ...
    float sizeLess = float(getTextHeight() * 2);
      ...
      analyzerEnabledButtonAttachment(audioProcessor.apvts, "Analyzer Enabled", analyzerEnabledButton)
{
    ...
    peakBypassButton.setLookAndFeel(&lnf1);
    highcutBypassButton.setLookAndFeel(&lnf1);
    lowcutBypassButton.setLookAndFeel(&lnf1);

    analyzerEnabledButton.setLookAndFeel(&lnf1);
...
void SimpleEQAudioProcessorEditor::paint(juce::Graphics &g)
{
    ...
    g.setFont(12);
    g.drawFittedText("Build: " + buildDate + "\nBy Wilfred Lopez", highCutSlopeSlider.getBounds().withY(6), Justification::topRight, 2);
}
